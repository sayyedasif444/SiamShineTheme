...
<body class="theme-color-5">
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                ...
                                <div class="brand-logo">
                                    <a href="index.html"><img src="../assets/images/icon/logo/1.png"
                                    ...
                                    <div class="icon-nav d-none d-sm-block">
                                        <ul>
                                            <li class="onhover-div mobile-search">
                                                <div><img src="../assets/images/icon/search.png" class="img-fluid blur-up lazyload" alt=""> <i class="ti-search"
                                                        ></i></div></li>
    ...
    <section class="p-0 position-relative overflow-hidden">
        <div class="home-slider">
            <div class="product-slick-animated">
                <div>
                    <div class="home">
                        <img src="../assets/images/jewellery/home-slider/3.jpg" alt="" class="bg-img blur-up lazyload">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                ...
                <div>
                    <div class="home">
                        <img src="../assets/images/jewellery/home-slider/4.jpg" alt="" class="bg-img blur-up lazyload">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                                    <div class="slider-contain product-detail">
            ...
            <div class="row thumbnail-porduct">
                <div class="col-lg-3 d-lg-block d-none m-auto">
                    <div class="animated-nav">
                        <div><img src="../assets/images/jewellery/home-slider/sm-1.jpg" alt=""
                                class="img-fluid blur-up lazyload"></div>
                        <div><img src="../assets/images/jewellery/home-slider/sm-2.jpg" alt=""
                                class="img-fluid blur-up lazyload"></div>
                        <div><img src="../assets/images/jewellery/home-slider/sm-1.jpg" alt=""
                                class="img-fluid blur-up lazyload"></div>
                    </div>
            ...
            <div class="row partition3">
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/jewellery/banner/6.jpg"
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/jewellery/banner/7.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner banner-3">
                                <div>
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/jewellery/banner/8.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner banner-3">
                                <div>
                    ...
                    <div class="product-4 product-m no-arrow">
                        <div class="product-box product-wrap product-style-2">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            src="../assets/images/jewellery/pro-grey/1.jpg"
                            ...
                            <div class="product-info">
                                ...
                                <ul class="color-variant image-swatch-demo">
                                    <li>
                                        <div><img src="../assets/images/jewellery/icon/rose-gold.jpg" alt=""
                                                class="img-fluid blur-up lazyload bg-img"></div>
                                    </li>
                                    <li>
                                        <div><img src="../assets/images/jewellery/icon/gold.jpg" alt=""
                                                class="img-fluid blur-up lazyload bg-img"></div>
                                    </li>
                                    <li>
                                        <div><img src="../assets/images/jewellery/icon/silver.jpg" alt=""
                                                class="img-fluid blur-up lazyload bg-img"></div>
                                    </li>
                                </ul>
                                <div class="add-btn">
                        ...
                        <div class="product-box product-wrap product-style-2">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            src="../assets/images/jewellery/pro-grey/2.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-wrap product-style-2">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            src="../assets/images/jewellery/pro-grey/3.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-wrap product-style-2">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            src="../assets/images/jewellery/pro-grey/4.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-wrap product-style-2">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            src="../assets/images/jewellery/pro-grey/5.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
    ...
    <section class="p-0">
        <div class="full-banner">
            <img src="../assets/images/jewellery/parallax-banner1.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="banner-contain">
                            <h2>2018</h2>
                            <h3 class="font-cormorant">fashion trends</h3>
                            <h4>special offer</h4>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="product-4 product-m no-arrow">
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/6.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                    ...
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/7.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
                                    ...
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/8.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
                                    ...
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/9.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
                                    ...
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/10.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
                                ...
                                <div class="product-4 product-m no-arrow">
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/11.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
                                    ...
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/12.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
                                    ...
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/13.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
                                    ...
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/14.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
                                    ...
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/15.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
                                ...
                                <div class="product-4 product-m no-arrow">
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/16.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
                                    ...
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/17.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
                                    ...
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/18.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
                                    ...
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/19.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
                                    ...
                                    <div class="product-box product-wrap product-style-2">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/jewellery/pro-grey/20.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail"><a href="javascript:void(0)"
                                                    title="Add to Wishlist"><i class="ti-heart"
    ...
    <section class="section-b-space">
        <div class="container">
            <div class="row partition3 partition_3">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            ...
                                            src="../assets/images/jewellery/pro-grey/21.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html">
                                            <h6 class="mt-0">Slim Fit Cotton Shirt</h6>
                                        </a>
                                        <h4>$500.00</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery/pro-grey/22.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html">
                                            <h6 class="mt-0">Slim Fit Cotton Shirt</h6>
                                        </a>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery/pro-grey/23.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html">
                                            <h6 class="mt-0">Slim Fit Cotton Shirt</h6>
                                        </a>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery/pro-grey/24.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html">
                                            <h6 class="mt-0">Slim Fit Cotton Shirt</h6>
                                        </a>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery/pro-grey/25.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html">
                                            <h6 class="mt-0">Slim Fit Cotton Shirt</h6>
                                        </a>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery/pro-grey/19.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html">
                                            <h6 class="mt-0">Slim Fit Cotton Shirt</h6>
                                        </a>
                ...
                <div class="col-lg-4 center-slider border-0 ratio_125">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="collection-banner p-left text-start tl-content">
                                    <div class="img-part">
                                        <img src="../assets/images/jewellery/vertical.jpg" alt=""
                                            class="img-fluid blur-up lazyload bg-img">
                                    </div>
                                    <div class="contain-banner banner-3">
                                        <div>
                                            <h4 class="text-theme">save 30%</h4>
                                            <h2 class="font-cormorant text-dark">sandle</h2>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery/pro-grey/18.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html">
                                            <h6 class="mt-0">Slim Fit Cotton Shirt</h6>
                                        </a>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery/pro-grey/17.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html">
                                            <h6 class="mt-0">Slim Fit Cotton Shirt</h6>
                                        </a>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery/pro-grey/16.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html">
                                            <h6 class="mt-0">Slim Fit Cotton Shirt</h6>
                                        </a>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery/pro-grey/15.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html">
                                            <h6 class="mt-0">Slim Fit Cotton Shirt</h6>
                                        </a>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery/pro-grey/14.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html">
                                            <h6 class="mt-0">Slim Fit Cotton Shirt</h6>
                                        </a>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            class="img-fluid blur-up lazyload"
                                            src="../assets/images/jewellery/pro-grey/13.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html">
                                            <h6 class="mt-0">Slim Fit Cotton Shirt</h6>
                                        </a>
